...
gj.grid.plugins.pagination = {
    ...
    private: {
        ...
        localizationBaseTheme: function (data) {
            ...
            if (typeof (data.pager.leftControls) === 'undefined') {
                data.pager.leftControls = [
                    $('<button title="' + msg.PreviousPageTooltip + '" data-role="page-previous" class="gj-cursor-pointer"><span>Â«</span></button>'),
                    ...
                    $('<button title="' + msg.NextPageTooltip + '" data-role="page-next" class="gj-cursor-pointer"><span>Â»</span></button> &nbsp;')
                ];
            }
            if (typeof (data.pager.rightControls) === 'undefined') {
                data.pager.rightControls = [
...
gj.tree.config = {
    ...
    glyphicons: {
        ...
        icons: {
            expand: '<span class="glyphicon glyphicon-triangle-right" />',
            collapse: '<span class="glyphicon glyphicon-triangle-bottom" />'
        }
    }
};
/**
